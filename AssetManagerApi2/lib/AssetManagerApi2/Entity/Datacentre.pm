package AssetManagerApi2::Entity::Datacentre;
...
my $datacentre_model = 'AssetManagerDB::Datacentre';
...
has 'dbic'       => (is       => 'ro', 
                     isa      => 'AssetManagerApi2::Schema::AssetManagerDB::Result::Datacentre',
                     builder  => '_build_dbic',
                    );
...
around BUILDARGS => sub {
    ...
    my $c    = $_[0]->{c};
    my $dbic = $c->model($datacentre_model)->find({id => $_[0]->{id}});
