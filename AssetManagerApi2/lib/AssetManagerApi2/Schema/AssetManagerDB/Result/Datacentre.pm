use utf8;
package AssetManagerApi2::Schema::AssetManagerDB::Result::Datacentre;
...
Related object: L<AssetManagerApi2::Schema::AssetManagerDB::Result::Asset>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:9Hqcj93OeSYXM60iGLzcJA
