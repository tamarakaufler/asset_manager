use utf8;
package AssetManagerApi::Schema::AssetManagerDB::Result::AssetSoftware;
...
AssetManagerApi::Schema::AssetManagerDB::Result::AssetSoftware
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Iw8fo6SIXY/HrsyEEG9sew
...
__PACKAGE__->belongs_to(
  "software",
  "AssetManagerApi::Schema::AssetManagerDB::Result::Software",
  { id => "software" },
  { is_deferrable => 1, on_update => "CASCADE" },
);
