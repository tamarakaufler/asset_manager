use utf8;
package AssetManager::Schema::Result::Datacentre;
...
Related object: L<AssetManager::Schema::Result::Asset>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:V5plGzUlrnVZrzWmEN6fOA
